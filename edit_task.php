...
<?php echo "<input type='text' name='deadline' id='deadline' value='".$deadline."'>";?>
</div>
<div data-role="fieldcontain">
<label for="rank">Rank</label>
<?php echo "<input type='range' name='rank' id='rank' value='".$rank."' min='0' max='10' data-highlight='true' />";?>
<span class="slider_left">0</span>
<span class="slider_right">10</span>
</div>
<div data-role="fieldcontain">
<label for="progress">Progress</label>
<?php echo "<input type='range' name='progress' id='progress' value='".$progress."' min='0' max='100' data-highlight='true' />";?>
<span class="slider_left">0%</span>
<span class="slider_right">100%</span>
</div>
<div data-role="fieldcontain">
<label for="number">Time Estimate in Hours</label>
<?php echo "<input type='number' name='hours' id='number' value='".$time."'>";?>
</div>
<div data-role="fieldcontain">
